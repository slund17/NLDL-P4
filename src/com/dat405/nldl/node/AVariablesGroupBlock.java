...
public final class AVariablesGroupBlock extends PGroupBlock
{
    private final LinkedList<PVar> _var_ = new LinkedList<PVar>();

    public AVariablesGroupBlock()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVariablesGroupBlock(
    ...
    {
        ((Analysis) sw).caseAVariablesGroupBlock(this);
    }
